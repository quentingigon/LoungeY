...
public interface FileApi {
    ...
    @RequestMapping(value = "/upload/{username}/image",
        consumes = { "multipart/form-data" },
        method = RequestMethod.POST)
    public ResponseEntity<Boolean> uploadFile(@RequestParam("file") MultipartFile file, @ApiParam(value = "username", required = true) @PathVariable("username") String username);
}
